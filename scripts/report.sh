...
python report_info.py a_out/faster_rcnn_r101_fpn_1x/latest.pth --out_name mmdetection-faster_rcnn_r101_fpn-1x --config configs/faster_rcnn/faster_rcnn_r101_fpn_1x_bdd100k.py
...
python report_info.py a_out/yolov3_608_273e/yolov3_d53_mstrain-608_273e_bdd100k.py --out_name mmdetection-yolov3_608-273e --config configs/yolo/yolov3_d53_mstrain-608_273e_bdd100k.py
